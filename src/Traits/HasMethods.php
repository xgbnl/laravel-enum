...
trait HasMethods
{
    ...
    {
        return array_reduce(self::cases(), function (array $cases, Enumerable|self $enum) use ($attribute, $lower): array {
    ...
    {
        return array_reduce(self::cases(), function (array $collection, Enumerable|Presenter|self $enum) use ($replacer, $options): array {
